...
Manual::Manual(QWidget *parent) : QWidget(parent)
{
    ...
    tabWidget->setGeometry(10, 10, 400, 300);

    QWidget *tab = new QWidget();
    tabWidget->addTab(tab, "Clientes");

    CustomTableWidget *tableWidget = new CustomTableWidget(tab);
    tableWidget->setGeometry(10, 10, 380, 280);
